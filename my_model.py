            ...
            make_node(
                ...
                init_decoder=make_graph(
                    ...
                    inputs=[
                        ...
                        helper.make_tensor_value_info('past_0', TensorProto.FLOAT16, shape=[2, 'batch_size', 8, 'max_seq_len', 32]),
                        helper.make_tensor_value_info('past_1', TensorProto.FLOAT16, shape=[2, 'batch_size', 8, 'max_seq_len', 32]),
                        helper.make_tensor_value_info('past_2', TensorProto.FLOAT16, shape=[2, 'batch_size', 8, 'max_seq_len', 32]),
                    ...
                    outputs=[
                        helper.make_tensor_value_info('logits', TensorProto.FLOAT16, shape=['batch_size', 1, 50110]),
                        helper.make_tensor_value_info('present_0', TensorProto.FLOAT16, shape=[2, 'batch_size', 8, 'max_seq_len', 32]),
                        helper.make_tensor_value_info('present_1', TensorProto.FLOAT16, shape=[2, 'batch_size', 8, 'max_seq_len', 32]),
                        helper.make_tensor_value_info('present_2', TensorProto.FLOAT16, shape=[2, 'batch_size', 8, 'max_seq_len', 32]),
                    ],
                    initializer=[
                    ...
                    value_info=[
                        ...
                        helper.make_tensor_value_info('logits', TensorProto.FLOAT16, shape=['batch_size', 1, 50110]),
                        helper.make_tensor_value_info('present_0', TensorProto.FLOAT16, shape=[2, 'batch_size', 8, 'total_seq_len', 32]),
                        helper.make_tensor_value_info('present_1', TensorProto.FLOAT16, shape=[2, 'batch_size', 8, 'total_seq_len', 32]),
                        helper.make_tensor_value_info('present_2', TensorProto.FLOAT16, shape=[2, 'batch_size', 8, 'total_seq_len', 32]),
                    ...
                    nodes=[
                        ...
                        make_node(
                            'Attention',
                            inputs=['e_EmbedLayerNormalization_0_output', 's_d_transformer.h.0.attn.c_attn.weight', 'e_transformer.h.0.attn.c_attn.bias', 'attention_mask', 'past_0', '', 'past_sequence_length'],
                            outputs=['e_GptAttention_0_output', 'present_0'],
                            name='GptAttention_0',
                            domain='com.microsoft',
                        ...
                        make_node(
                            'Attention',
                            inputs=['e_onnx::Shape_345', 's_d_transformer.h.1.attn.c_attn.weight', 'e_transformer.h.1.attn.c_attn.bias', 'attention_mask', 'past_1', '', 'past_sequence_length'],
                            outputs=['e_GptAttention_1_output', 'present_1'],
                            name='GptAttention_1',
                            domain='com.microsoft',
                            mask_filter_value=-3.4028234663852886e+38,
                            num_heads=8,
                        ...
                        make_node(
                            'Attention',
                            inputs=['e_onnx::Shape_593', 's_d_transformer.h.2.attn.c_attn.weight', 'e_transformer.h.2.attn.c_attn.bias', 'attention_mask', 'past_2', '', 'past_sequence_length'],
                            outputs=['e_GptAttention_2_output', 'present_2'],
                            name='GptAttention_2',
                            domain='com.microsoft',
                            mask_filter_value=-3.4028234663852886e+38,
                            num_heads=8,
                        ...
                        make_node('MatMul', inputs=['e_onnx::Reshape_834', 's_d_onnx::MatMul_908'], outputs=['logits'], name='MatMul_711'),
                    ],
                ),
                decoder=make_graph(
                    name='gpt2 decoder',
                    ...
                    nodes=[
                        ...
                        make_node(
                            ...
                            outputs=['d_GptAttention_0_output', 'present_0'],
                            name='GptAttention_0',
                            domain='com.microsoft',
                            mask_filter_value=-3.4028234663852886e+38,
                            num_heads=8,
                        ...
                        make_node(
                            ...
                            outputs=['d_GptAttention_1_output', 'present_1'],
                            name='GptAttention_1',
                            domain='com.microsoft',
                            mask_filter_value=-3.4028234663852886e+38,
                            num_heads=8,
                        ...
                        make_node(
                            ...
                            outputs=['d_GptAttention_2_output', 'present_2'],
                            name='GptAttention_2',
                            domain='com.microsoft',
                            mask_filter_value=-3.4028234663852886e+38,
                            num_heads=8,
                        ...
                        make_node('MatMul', inputs=['d_onnx::Reshape_834', 's_d_onnx::MatMul_908'], outputs=['logits'], name='MatMul_711'),
                    ],
                ),
            ),
        ],
